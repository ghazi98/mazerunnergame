...
public class Game implements ProgressListener {
    ...
    /**
     * Prompts the player to enter the maze height and maze width and show the game introduction.
     * Note: The difficulty of the game increases with the size of the maze.
     * 
     ...
     * the player can control the Player's movement by using the arrow keys.
     * 
