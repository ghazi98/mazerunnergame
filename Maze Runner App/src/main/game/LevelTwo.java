 ...
 * Level details:
 * 
 * Mission: find the exit to win the game</li>
...
public class LevelTwo implements KeyListener {
    ...
    /**
     * Updates the game statistics if player has reached the exit.
     */
     ...
     * 
     * If the arrow keys is pressed, the movement is validated first.
