...
class LevelOne implements KeyListener {
    ...
    /**
     * Updates the game statistics if the player has reached specified items in the game.
     */
     ...
     * 
     * Note: The F6 key is used for debugging purposes to reveal the map even the map is previously covered.
