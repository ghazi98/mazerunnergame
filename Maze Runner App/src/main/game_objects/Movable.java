...
/**
 * This interface is implemented by a {GameObject} such as {Player}.
 * A Movable is a GameObject that can change its {Position} in the maze.
 * The move method is invoked to change the {Position} of the Movable.
 */
